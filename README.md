...
NEW: <br>
    ...
    Для запуска проекта необходимо: <br>
        1. Создать виртуальное окружение и активировать его <br>
        2. Установить зависимости из requirements.txt <br>
        3. Запустить проект командой: uvicorn main:app --reload либо "py .\BackEnd\main.py" <br>
        4. И открыть index.html <br>
